...
void test_morse_character_spacing(void) {
    ...
    morse->start_morse("EE", 20); // Two E's
...
void test_morse_element_spacing_timing(void) {
    ...
    morse->start_morse("A", 20); // A = dot-dash
